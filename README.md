...
## Transição para o Software
Sou apaixonado por lógica e programação. No momento, estou mergulhado no aprendizado de **Python** e preparando minha transição definitiva para o mercado de desenvolvimento de software.

*"Unindo décadas de experiência em automação industrial com as novas possibilidades do desenvolvimento de sistemas."*

## Tecnologias que estudo
<div style="display: inline_block"><br>
<img align="center" alt="Python" height="40" width="40"  style="margin-right: 30px;
